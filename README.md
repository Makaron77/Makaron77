...
<h3 align="center">Мои проекты и те в которых я принимал участие в командной разработке</h3>
- [Адаптивный лендинг ресторана с функционалом](https://github.com/Makaron77/Restaurant)
- [Сайт для путешественников, с построением маршрутов, админ панелью, регистрацией и возможностью бронирования мест отдыха на всем маршруте сразу](https://github.com/Vtalcom/JourneyCamp)
- [Сайт для продажи носков, с генератором на подобии "Все майки"](https://github.com/Ketark/SocksShop)
